...
INSERT INTO `wardrobe_agencies` VALUES (1,'olympus','Olympus',NULL,1,1424428138,1424901521,'new item (standard) created',1),(2,'dollhouse','Dollhouse',NULL,1,1424771470,1424784377,'new shelf (imprint) created',1),(6,'disney','Disney',NULL,1,1424774337,1424774764,'new shelf (hair) created',1);
...
INSERT INTO `wardrobe_items` VALUES (1,'normal-body','Normal body',1,1,1,1424895459,1424895459,0,'assets/agencies/olympus/aphrodite/normal-body.1.1.png','this item created',1),(2,'high-boots','High boots',1,11,1,1424895582,1424895582,0,'assets/agencies/olympus/aphrodite/high-boots.2.2.png','this item created',1),(3,'alien-body','Alien body',1,1,1,1424900896,1424900896,0,'assets/agencies/olympus/aphrodite/alien-body.3.3.png','this item created',1),(4,'standard','Standard',1,12,1,1424901521,1424901521,50,'assets/agencies/olympus/aphrodite/standard.4.4.png','this item created',1);
...
INSERT INTO `wardrobe_layers` VALUES (1,1,0,295.00,44.00),(2,2,0,279.00,710.00),(3,3,0,295.00,44.00),(4,4,50,446.00,34.00);
...
INSERT INTO `wardrobe_models` VALUES (1,'aphrodite','Aphrodite',1,1,NULL,1424457875,1424901521,'new item (standard) created',1,1000),(2,'athena','Athena',1,1,NULL,1424772801,1424772801,NULL,0,800),(3,'echo','Echo',2,1,NULL,1424773364,1424784377,'new shelf (imprint) created',1,1000),(4,'sierra','Sierra',2,1,NULL,1424773370,1424773370,NULL,0,1000),(5,'cinderella','Cinderella',6,1,NULL,1424774359,1424774359,'this item created',1,1000),(6,'pocahontas','Pocahontas',6,1,NULL,1424774461,1424774764,'new shelf (hair) created',1,1000);
...
INSERT INTO `wardrobe_users` VALUES (1,'lerayne',NULL,'lerayne@gmail.com','062ac7c968833af0f79b2ff4a9de644e','2010-03-12 15:48:00',1,'local','2015-02-26 03:47:42','online');
...
-- Dump completed on 2015-02-26  3:48:34
