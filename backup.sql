...
INSERT INTO `wardrobe_agencies` VALUES (1,'olympus','Olympus',NULL,1,1424428138,1425088079,'new item (Maxi 2) created',1),(2,'dollhouse','Dollhouse',NULL,1,1424771470,1424784377,'new shelf (imprint) created',1),(6,'disney','Disney',NULL,1,1424774337,1424774764,'new shelf (hair) created',1);
...
INSERT INTO `wardrobe_layers` VALUES (1,1,0,295,44),(2,2,180,279,710),(3,3,0,295,44),(4,4,800,446,34),(5,5,250,452,171),(6,6,200,420,376),(7,7,100,294,383),(8,8,100,294,383),(9,9,100,294,383),(10,10,100,294,383),(11,12,180,281,862),(12,13,200,393,376),(13,14,5,556,431),(14,15,200,414,376),(15,16,200,414,376);
...
INSERT INTO `wardrobe_models` VALUES (1,'aphrodite','Aphrodite',1,1,NULL,1424457875,1425088079,'new item (Maxi 2) created',1,1000),(2,'athena','Athena',1,1,NULL,1424772801,1424772801,NULL,0,800),(3,'echo','Echo',2,1,NULL,1424773364,1424784377,'new shelf (imprint) created',1,1000),(4,'sierra','Sierra',2,1,NULL,1424773370,1424773370,NULL,0,1000),(5,'cinderella','Cinderella',6,1,NULL,1424774359,1424774359,'this item created',1,1000),(6,'pocahontas','Pocahontas',6,1,NULL,1424774461,1424774764,'new shelf (hair) created',1,1000);
...
INSERT INTO `wardrobe_shelves` VALUES (1,'body','Body',1,1,NULL,0,1424466514,1425086211,'new instance (\"Heavy tan\") of item \"Normal body\" created',1,0),(6,'skirts','Skirts',1,1,NULL,200,1424467949,1425088079,'new item (Maxi 2) created',1,0),(7,'pants','Pants',1,1,NULL,150,1424471086,1424471086,NULL,0,0),(8,'tattoo','Tattoo',6,1,NULL,100,1424774531,1424774531,'this item created',1,0),(9,'hair','Hair',6,1,NULL,150,1424774764,1424774764,'this item created',1,0),(10,'imprint','Imprint',3,1,NULL,0,1424784377,1424784377,'this item created',1,0),(11,'shoes','Shoes',1,1,NULL,500,1424870690,1425077805,'new item (pumps) created',1,0),(12,'hair','Hair',1,1,NULL,800,1424901497,1424901521,'new item (standard) created',1,0),(13,'top','Top',1,1,NULL,250,1424954408,1424954437,'new item (american-belly) created',1,0),(14,'tights','Tights',1,1,NULL,100,1424955677,1424957128,'new item (candies) created',1,0),(15,'underware','Underware',1,1,NULL,50,1425075972,1425075972,'this item created',1,1),(16,'tattoo','Tattoo',1,1,NULL,5,1425086527,1425086549,'new item (Leg 1) created',1,0);
...
INSERT INTO `wardrobe_users` VALUES (1,'lerayne',NULL,'lerayne@gmail.com','062ac7c968833af0f79b2ff4a9de644e','2010-03-12 15:48:00',1,'local','2015-02-28 04:21:24','online');
...
-- Dump completed on 2015-02-28  4:24:31
